...
//////////////////////////////////////////////////////////////////////////
   ...
   */
  public final HGrid pointWrite(HRef id, int level, HVal val, String who, HNum dur, HDict opts)
  {
    // argument checks
    ...
    if (rec.missing("writable"))
      ...
      return onPointWrite(rec, level, val, who, dur, opts);
  }
   ...
   */
  protected abstract HGrid onPointWrite(HDict rec, int level, HVal val, String who, HNum dur, HDict opts);
